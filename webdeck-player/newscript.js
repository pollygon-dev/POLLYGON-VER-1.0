...
*/
var myPlaylists = {
    "Faves": 'PLqnhflFMWUZnaDBWEun0joYmlNEzgpz5k',
...
document.getElementById("player-theme").setAttribute("href", "./themes/"+ myThemes[currentTheme] + "/webdeck-playerr.css");
...
volumeButton.innerHTML = "<img src='./themes/" + myThemes[currentTheme] + "/imagess/sound.png' alt=''>";
...
prevButton.innerHTML = "<img src='./themes/" + myThemes[currentTheme] + "/imagess/prev.png' alt=''>";
playButton.innerHTML = "<img src='./themes/" + myThemes[currentTheme] + "/imagess/play.png' alt=''>";
stopButton.innerHTML = "<img src='./themes/" + myThemes[currentTheme] + "/imagess/stop.png' alt=''>";
nextButton.innerHTML = "<img src='./themes/" + myThemes[currentTheme] + "/imagess/next.png' alt=''>";
infoButton.innerHTML = "<img src='./themes/" + myThemes[currentTheme] + "/imagess/info.png' alt=''>";
...
volumeButton.addEventListener("click", function(){
    if(volumeBar.value != 0){
        ...
        player.setVolume(0);
        volumeBar.value = 0;
        volumeButton.innerHTML = "<img src='./themes/" + myThemes[currentTheme] + "/imagess/mute.png' alt=''>";
    }
    else{
...
function onPlayerStateChange(event) {
    ...
    if(player.getPlayerState() == 1 /* Playing */) {
        playButton.innerHTML = "<img src='./themes/" + myThemes[currentTheme] + "/imagess/pause.png' alt=''>";
    }
    else {
        playButton.innerHTML = "<img src='./themes/" + myThemes[currentTheme] + "/imagess/play.png' alt=''>";
    }
